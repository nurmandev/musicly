                ...
                <div className="row align-items-end mb-25 bdFadeUp">
                    <div className="col-lg-8">
                        <div className="section__title-wrapper mb-40 bd-title-anim">
                            <span className="section__subtitle">Trending DJ's</span>
                            <div id="msg-title">
                                <h2 className="section__title">These DJ's are <span className="animated-underline active">popular A.F</span> {" "}
                                    </h2>
                            </div>
                        </div>
                    </div>
