    ...
    const work_future_data: TWorkFuture[] = [
        {
            ...
            title: "Find the Chosen One.",
            description: "Pick the people you vibe with the most, you can check their portfolio for more info"
        },
        {
            id: 2,
            icon: <WorkFutureSvgIconTwo />,
            title: "Let our A.I do the Hard work.",
            description: "Our A.I will do the hard work of connecting all the dots for you, so you can focus on the fun stuff."
        },
        {
            id: 3,
            icon: <WorkFutureSvgIconThree />,
            title: "Drinks on the Beach.",
            description: "Sit back, relax, and watch your party come to life. No stress, no hassle, only good vibes allowed 😎."
        },
    ]
    return (
        <>
                        ...
                        <div className="col-xl-6">
                            <div className="work__content-wrapper work__content-space mb-70 pl-40">
                                <div className="section__title-wrapper mb-50 bd-title-anim">
                                    ...
                                    The easy way to book a 
                                        <span className="animated-underline active">DJ anywhere</span>
                                    </h2>
                                </div>
