                    ...
                    <div className="row justify-content-center">
                        <div className="col-xxl-10">
                            <div className="ms-find-musician-wrap">
                                <h2 className="ms-find-musician-title mb-65 text-center bd-title-anim">Time to Spice up your parties! 
                                <span>  Hire</span>
                                <span className="ms-text-gradient1"> Live</span>
                                    <span className="ms-color-1"> DJ</span> 
                                    <span className="ms-text-gradient2"> Entertainment</span> 
                                </h2>

                                {/* <h2 className="ms-find-musician-title mb-65 text-center bd-title-anim">Make your day unforgettable! 
                                Hire 
                                <span className="ms-text-gradient1"> Live</span>
                                    <span className="ms-color-1"> DJ</span> 
                                    <span className="ms-text-gradient2"> Entertainment</span> 
