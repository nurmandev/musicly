        ...
        <>
            <div className={`${spacingClass} ms-news-sidebar`}>
                ...
                <div className="ms-news-widget">
                    ...
                    <ul>
                        <li><Link href="/news-details">Alternative Music</Link></li>
                        <li><Link href="/news-details">Asian Pop (J-Pop, K-Pop)</Link></li>
                        <li><Link href="/news-details">Classical Music</Link></li>
                        <li><Link href="/news-details">Dance Music</Link></li>
                        <li><Link href="/news-details">Easy Listening</Link></li>
                        <li><Link href="/news-details">Electronic Music</Link></li>
                        <li><Link href="/news-details">European Music (Folk/Pop)</Link></li>
                    </ul>
                </div>
                <div className="ms-news-widget">
                                ...
                                <div className="rc-post" key={item.id}>
                                    <div className="d-flex">
                                        ...
                                        <div className="rc-text widget-post-body">
                                            ...
                                            <h6 className="widget-post-title"><Link href={`/news-details/${item.id}`}>
                                                {item.title}</Link></h6>
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="ms-news-widget">
                    ...
                    <div className="tagcloud">
                        <Link href="/news">Music</Link>
                        <Link href="/news">Entertainer</Link>
                        <Link href="/news">Events</Link>
                        <Link href="/news">Album</Link>
                        <Link href="/news">Musician</Link>
                        <Link href="/news">Bands</Link>
                    </div>
                </div>
                <div className="ms-news-widget">
