                                    ...
                                    latest_news_data.slice(24, 28).map((item) => (
                                        <div className="ms-news-box mb-25" key={item.id}>
                                            <div className="ms-news-img m-img fix ms-br-15 mb-30">
                                                ...
                                                <span className="ms-news-cat"><Link href={`/news-details/${item.id}`}>{item.category}</Link></span>
                                                {
                                                    item.videoUrl &&
                                            ...
                                            <div className="ms-news-content">
                                                ...
                                                <h3 className="ms-news-title2 mb-30"><Link href={`/news-details/${item.id}`}>{item.title}</Link></h3>
                                                <p className="mb-45">{item.description}</p>
                                                <div className="ms-news-btn">
                                                    <Link className="ms-border-btn" href={`/news-details/${item.id}`}>Continue
                                                        Reading</Link>
                                                </div>
                                            </div>
                                        </div>
