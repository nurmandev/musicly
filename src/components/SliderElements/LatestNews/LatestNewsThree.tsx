                                    ...
                                    <SwiperSlide key={item.id}>
                                        <div className="ms-news3-slick">
                                            <div className="ms-news3-item p-relative">
                                                <Link className="ms-news3-cat" href={`/news-details/${item.id}`}>{item.category}</Link>
                                                <h3 className="ms-news3-title"><Link href={`/news-details/${item.id}`}>{item.title}</Link></h3>
                                                <div className="ms-news-meta">
                                                    <ul>
                                                        <li><span>{item.date}</span></li>
                                                        <li><Link href={`/news-details/${item.id}`}>{item.comment} Comments</Link></li>
                                                    </ul>
                                                </div>
